...
export function Inspector({
  ...
  const controls = selectedBlock
    ? blockDefinition?.controls ?? []
    : sectionDefinition?.controls ?? [];
  ...
  return (
    ...
    >
      ...
      >
        {/* Explicit parent link for blocks */}
        {selectedBlock && (
        ...
        <div className="px-4 py-4">
          {controls.length > 0 ? (
            ...
            <div className="py-12 text-center">
              ...
              <p className="mx-auto mt-1 max-w-[220px] text-[11px] leading-5 text-[#9a9a9a]">
                This item doesn&apos;t
                have additional
                settings.
              </p>
        ...
        {!selectedBlock &&
          section.blocks.length >
            ...
            <section className="border-t border-[#eeeeee] px-2 py-3">
              <h2 className="px-2 pb-2 text-[10px] font-semibold uppercase tracking-[0.06em] text-[#8c9196]">
                Content
              </h2>
