-- Phase one only. Generated from the initial tenant and storefront data model, then
...
-- The application layer does not represent these CHECK constraints or immutability triggers.
