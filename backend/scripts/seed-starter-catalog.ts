...
const products: SeedProduct[] = [
  { id: "product-vanilla-cake", storeId: "store-sweet-bakes", slug: "vanilla-celebration-cake", title: "Vanilla Celebration Cake", description: "Vanilla bean sponge, cloud cream, raspberry preserve, and a confetti crown.", productType: "Cakes", variantId: "vanilla-cake", variantTitle: "1 kg", sku: "SB-CAKE-VAN-1KG", priceMinor: 149900, quantity: 9 },
  { id: "product-berry-cloud", storeId: "store-sweet-bakes", slug: "berry-cloud-bento", title: "Berry Cloud Bento", description: "A tiny berry sponge made for two, finished with blush buttercream.", productType: "Cakes", variantId: "berry-cloud", variantTitle: "500 g", sku: "SB-BENTO-BRY", priceMinor: 74900, quantity: 3 },
  { id: "product-lemon-tart", storeId: "store-sweet-bakes", slug: "lemon-joy-tart", title: "Lemon Joy Tart", description: "Silky lemon curd in a crisp almond shell with toasted meringue.", productType: "Tarts", variantId: "lemon-tart", variantTitle: "6 inch", sku: "SB-TART-LEM", priceMinor: 89900, quantity: 7 },
  { id: "product-cookie-box", storeId: "store-sweet-bakes", slug: "afternoon-cookie-box", title: "Afternoon Cookie Box", description: "Six soft-centred cookies: sea salt chocolate, pistachio, and brown butter.", productType: "Gifts", variantId: "cookie-box", variantTitle: "Box of 6", sku: "SB-COOKIE-6", priceMinor: 59900, quantity: 12 },
...
const stores = [
  { id: "store-sweet-bakes", name: "Sweet Bakes", slug: "sweet-bakes" },
